...
MODELS_TO_TEST = [
    ...
    # 8. MetaCLIP Huge (The Challenger - Replaces DataComp/VLM2Vec)
...
if __name__ == "__main__":
    ...
    print("\n" + "="*120)
    print("GRAND SLAM BENCHMARK RESULTS (V15 - THE FINAL 8)")
    print("="*120)
    if len(results) > 0:
        keys = results[0].keys()
        ...
        pd.DataFrame(results).to_csv("benchmark_v15_results.csv", index=False)
