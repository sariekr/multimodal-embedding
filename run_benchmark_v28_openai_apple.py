"""
V28 - OpenAI CLIP-L & Apple DFN5B-H ONLY (PyTorch 2.8+ Required)

This version only benchmarks OpenAI and Apple models.
Requires PyTorch 2.8+ due to pytorch_model.bin security fix (CVE-2025-32434).
...
Requirements:
  - PyTorch 2.8+ (use RunPod template: runpod/pytorch:1.0.2-cu1281-torch280-ubuntu2404)
  - transformers, datasets, pillow, pandas, tabulate
"""
...
def parse_args():
    ...
    parser.add_argument("--output", type=str, default="benchmark_v28_openai_apple_results.csv", help="Output CSV file")
...
def get_models_to_test():
    """Returns model configurations - OpenAI & Apple ONLY (requires PyTorch 2.8+)"""
    return [
