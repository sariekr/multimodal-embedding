#!/usr/bin/env python3
"""
Debug script to test SigLIP-400M embedding behavior (for comparison with Base).
"""
...
print("Loading SigLIP-400M model...")
model = SiglipModel.from_pretrained('google/siglip-so400m-patch14-384').eval()
